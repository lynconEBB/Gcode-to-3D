...
def dist_ref(script):
    filter_xml = ''.join([
        ...
        '    <Param name="MeasureMesh" description="Measured Mesh/PointCloud" value="1" type="RichMesh"/>\n ',
        '    <Param name="RefMesh" description="Reference Mesh/PointCloud" value="0" type="RichMesh"/>\n ',
        '    <Param name="SignedDist" description="Compute Signed Distance" value="true" type="RichBool"/>\n ',
        '  </filter>\n'])
    util.write_filter(script, filter_xml)
    return None
